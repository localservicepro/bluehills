...
const cards = [
  ...
  { n: '02', href: '/acreage-mowing/', title: 'Acreage Mowing', src: img.newAcreage1,
    alt: 'Open acreage lawn mown clean beneath established shade trees by Blue Hills',
  ...
  { n: '03', href: '/hedge-trimming/', title: 'Hedge Trimming &amp; Reductions', src: img.newHedge2,
    alt: 'Street corner hedge above a retaining wall trimmed to a clean line by Blue Hills',
  ...
  { n: '05', href: '/weed-control/', title: 'Weed Management &amp; Block Slashing', src: img.newWeed1,
    alt: 'Zero-turn mower slashing a vacant residential block in South-East Melbourne',
